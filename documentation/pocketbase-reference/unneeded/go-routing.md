...
<center class="txt-hint">
        ...
        [
            `*core.RequestEvent`
        ]({import.meta.env.PB_GODOC_URL}/core#RequestEvent) value.
...
##### Reading request body
    ...
    [
        `e.BindBody`
    ]({import.meta.env.PB_GODOC_URL}/tools/router#Event.BindBody)
    ...
    *(the specific binding rules and which one will be used depend on the request Content-Type)*:
    ...
    - 
        ...
        ]({import.meta.env.PB_GODOC_URL}/tools/router#UnmarshalRequestData)
        method.
...
##### Writing response body
    ...
    *
        ...
        [
            `router.Event`
        ]({import.meta.env.PB_GODOC_URL}/tools/router#Event)
        .
    *
...
```
    ...
    ]({import.meta.env.PB_GODOC_URL}/tools/router#RouterGroup.Bind)
    /
    [
        `Route.Bind(middlewares...)`
    ]({import.meta.env.PB_GODOC_URL}/tools/router#Route.Bind)
    ...
    ]({import.meta.env.PB_GODOC_URL}/tools/router#RouterGroup.BindFunc)
    /
    [
        `Route.BindFunc(funcs...)`
    ]({import.meta.env.PB_GODOC_URL}/tools/router#Route.BindFunc) .
...
##### Builtin middlewares
    ...
    [
        `apis`
    ]({import.meta.env.PB_GODOC_URL}/apis)
    ...
    - 
        **WWW redirect**
        <small class="txt-hint">
            ...
            ]({import.meta.env.PB_GODOC_URL}/apis#pkg-constants)
            [
...
##### Serving static directory
    ...
    [
        `apis.Static()`
    ]({import.meta.env.PB_GODOC_URL}/apis#Static)
...
##### Auth response
    ...
    ]({import.meta.env.PB_GODOC_URL}/apis#RecordAuthResponse)
...
##### Enrich record(s)
    ...
    [
        `apis.EnrichRecord()`
    ]({import.meta.env.PB_GODOC_URL}/apis#EnrichRecord)
    and
    [
        `apis.EnrichRecords()`
    ]({import.meta.env.PB_GODOC_URL}/apis#EnrichRecords)
...
##### Go http.Handler wrappers
    ...
    ]({import.meta.env.PB_GODOC_URL}/apis#WrapStdHandler)
    and
    [
        `apis.WrapStdMiddleware(func)`
    ]({import.meta.env.PB_GODOC_URL}/apis#WrapStdMiddleware)
    functions.
