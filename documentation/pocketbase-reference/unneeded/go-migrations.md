...
##### 0. Register the migrate command
    ...
    *
        ...
        [
            `migratecmd`
        ]({import.meta.env.PB_GODOC_URL}/plugins/migratecmd)
        subpackage.
    *
...
>             [Collection operations](/docs/go-collections) and
>             [Record operations](/docs/go-records)
>             for more details how to interact with the database. You can also find
>             [some examples](#examples) further below in this guide.
>         
...
##### Creating collection programmatically
    ...
    *
        ...
        [Collection operations](/docs/go-collections)
    *
    .
