PocketBase comes with a thin abstraction between the local filesystem and S3.
    ...
    *Dashboard > Settings > Files storage* section.
    ...
    [
        `app.NewFilesystem()`
    ]({import.meta.env.PB_GODOC_URL}/core#BaseApp.NewFilesystem)
    method.
    ...
    [
        `filesystem`
    ]({import.meta.env.PB_GODOC_URL}/tools/filesystem)
    subpackage.
...
## Reading files
    ...
    [
        `GetReader(key)`
    ]({import.meta.env.PB_GODOC_URL}/tools/filesystem#System.GetReader)
    .
    ...
    [
        `List(prefix)`
    ]({import.meta.env.PB_GODOC_URL}/tools/filesystem#System.List)
    .
...
## Saving files
    ...
    - 
        [
            `Upload([]byte, key)`
        ]({import.meta.env.PB_GODOC_URL}/tools/filesystem#System.Upload)
    

    - 
        [
            `UploadFile(*filesystem.File, key)`
        ]({import.meta.env.PB_GODOC_URL}/tools/filesystem#System.UploadFile)
...
## Deleting files
    ...
    [
        `Delete(key)`
    ]({import.meta.env.PB_GODOC_URL}/tools/filesystem#System.Delete)
    .
