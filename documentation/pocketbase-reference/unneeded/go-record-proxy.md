The available [`core.Record` and its helpers](/docs/go-records)
    ...
    ]({import.meta.env.PB_GODOC_URL}/core#BaseRecordProxy)
    *(which implements the `core.RecordProxy` interface)* and define your collection fields as
    getters and setters.
