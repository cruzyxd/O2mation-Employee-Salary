By default PocketBase sends realtime events only for Record create/update/delete operations (<em
    ...
    ]({import.meta.env.PB_GODOC_URL}/core#BaseApp.SubscriptionsBroker) instance.
    ...
    ]({import.meta.env.PB_GODOC_URL}/tools/subscriptions#Broker.Clients)
    returns all connected
    [
        `subscriptions.Client`
    ]({import.meta.env.PB_GODOC_URL}/tools/subscriptions#Client)
    ...
    ]({import.meta.env.PB_GODOC_URL}/tools/subscriptions#Broker.ChunkedClients)
