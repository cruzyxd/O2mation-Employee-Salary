[
    ...
    `$app.db()`
    returns a `dbx.Builder` that can run all kinds of SQL statements, including raw queries.
...
>             you could also check [Collection operations](/docs/js-collections)
>             and
>             [Record operations](/docs/js-records) sections.
>         
...
```
    ...
    - 
            ...
            [
                `DynamicModel`
            ](/jsvm/classes/DynamicModel.html)
            object:
