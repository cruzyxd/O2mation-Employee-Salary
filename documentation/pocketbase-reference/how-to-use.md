The easiest way to use PocketBase is by interacting with its Web APIs directly from the client-side (e.g.
    ...
    [collection API rules](/docs/api-rules-and-filters/)
    .
    ...
    [extend PocketBase with Go or JavaScript](/docs/use-as-framework/)
    .
...
(Web, Mobile, Desktop, CLI)
    ...
    <Accordion single title="Web apps recommendation">
            ...
            - 
                [Use PocketBase as Go/JS framework](/docs/use-as-framework) to create new routes or
                intercept existing.
...
```
    ...
    <Accordion single title="Why not JS SSR">
            ...
            **in a JS SSR mode**
            ...
            ](https://github.com/pocketbase/pocketbase/discussions/5313) but some of the common pitfalls are:
