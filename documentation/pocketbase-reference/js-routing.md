You can register custom routes and middlewares by using the top-level
    [
        `routerAdd()`
    ](/jsvm/functions/routerAdd.html)
    and
    [
        `routerUse()`
    ](/jsvm/functions/routerUse.html)
    functions.
...
<center class="txt-hint">
        ...
        [
            `core.RequestEvent`
        ](/jsvm/interfaces/core.RequestEvent.html) value.
...
##### Reading request body
    ...
    [
        `e.bindBody`
    ](/jsvm/interfaces/core.RequestEvent.html#bindBody)
...
##### Serving static directory
    ...
    [
        `$apis.static()`
    ](/jsvm/functions/_apis.static.html)
...
##### Auth response
    ...
    ](/jsvm/functions/_apis.recordAuthResponse.html)
...
##### Enrich record(s)
    ...
    [
        `$apis.enrichRecord()`
    ](/jsvm/functions/_apis.enrichRecord.html)
    and
    [
        `$apis.enrichRecords()`
    ](/jsvm/functions/_apis.enrichRecords.html)
