PocketBase comes with a thin abstraction between the local filesystem and S3.
    ...
    *Dashboard > Settings > Files storage* section.
    ...
    [
        `$app.newFilesystem()`
    ](/jsvm/functions/_app.newFilesystem.html)
    method.
    ...
    [
        `filesystem.System`
    ](/jsvm/interfaces/filesystem.System.html)
    interface.
...
## Reading files
    ...
    [
        `getReader(key)`
    ](/jsvm/interfaces/filesystem.System.html#getReader)
    .
    ...
    [
        `list(prefix)`
    ](/jsvm/interfaces/filesystem.System.html#list)
    .
...
## Saving files
    ...
    - 
        [
            `upload(content, key)`
        ](/jsvm/interfaces/filesystem.System.html#upload)
    

    - 
        [
            `uploadFile(file, key)`
        ](/jsvm/interfaces/filesystem.System.html#uploadFile)
    

    - 
        [
            `uploadMultipart(mfh, key)`
        ](/jsvm/interfaces/filesystem.System.html#uploadMultipart)
...
## Deleting files
    ...
    [
        `delete(key)`
    ](/jsvm/interfaces/filesystem.System.html#delete)
    .
