One of the main features of PocketBase is that
    **it can be used as a framework** which enables you to write your own custom app business
    logic in
    [Go](/docs/go-overview) or [JavaScript](/docs/js-overview) and still have a portable
    backend at the end.
    ...
    **
        Choose [Extend with Go](/docs/go-overview) if you are already familiar
    ...
    **
        Choose [Extend with JavaScript](/docs/js-overview)
...
With both Go and JavaScript, you can:
    ...
    For further info, please check the related [Extend with Go](/docs/go-overview) or
    [Extend with JavaScript](/docs/js-overview) guides.