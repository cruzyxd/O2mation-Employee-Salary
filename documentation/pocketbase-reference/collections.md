## Overview
    ...
    **name** and **fields** (columns).
    ...
    [client-side SDKs](/docs/how-to-use/)
    (*superusers only*) or programmatically via the
    [Go](/docs/go-migrations/)/[JavaScript](/docs/js-migrations/)
    migrations.
    ...
    [Go](/docs/go-records/)/[JavaScript](/docs/js-records/)
    Record operations.
...
The following additional set modifiers are available:
                ...
                - 
                    ...
                    `{`{"slug:autogenerate":"abc-"}`}` will result in `"abc-[random]"`
                    `slug` field value.
...
The following additional set modifiers are available:
                ...
                [Files upload and handling](/docs/files-handling/) guide.
